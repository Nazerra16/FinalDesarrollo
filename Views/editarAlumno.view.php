                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $alumno->apellido ?>" name="apellido" id="apellido"
                                    class="form-control">
                            </div>
                            <div class="form-group" id="fecnac">
                                <label for="fecnac">Fecha de Nacimiento</label>
                                <input type="date" value="<?= $alumno->fecnac ?>" name="fecnac"
                                    id="fecnac" class="form-control">
                            </div>
