            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table id="listaProfesores" class="table table-sm table-striped table-bordered"
                            style="width:100%">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="eliminarProfesor.php?id=<?= $profesor->id; ?>"
                                                    class="btn btn-danger btn-sm">Eliminar</a>
                                                <a href="indexProfesorMaterias.php?id=<?= $profesor->id; ?>"
